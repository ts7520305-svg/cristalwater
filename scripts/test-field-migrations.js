...
(async()=>{
 ...
 try{
  ...
  await require('./fixtures/labor-composition-migration')({prisma,cli,dbRejects,repairLaborData,repairLabor});
  ...
  console.log('PASS thirty-two additive migrations preserve previous data and match the current schema');
