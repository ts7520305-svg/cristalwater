...
(async()=>{
 ...
 try{
  ...
  await prisma.$disconnect();
  for(const migration of ['20260914140000_water_reminder_replay','20260914150000_visit_completion_replay','20260914160000_browser_push','20260914190000_round_assignment_periods','20260914220000_round_recurrence','20260915060000_repair_quotes','20260915080000_client_rate_plans','20260915100000_quote_portal','20260915120000_equipment_maintenance','20260916090000_internal_chat'])cli(['db','execute','--file',`prisma/migrations/${migration}/migration.sql`,'--schema','prisma/schema.prisma']);
  ...
  console.log('PASS ten additive migrations preserve previous data and match the current schema');
