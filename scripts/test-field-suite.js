...
scripts.push('test-field-payment-ledger.js');
scripts.push('test-field-pool-calculator-state.js');
scripts.push('test-field-pool-calculator-writes.js','test-field-pool-calculator-recovery.js');
scripts.push('test-field-pool-calculator-drafts.js');
...
scripts.push('test-field-fleet-management.js','test-field-fleet-management-ui.js');
...
scripts.push('test-field-technician-guide-ui.js','test-field-document-summary-ui.js');
...
scripts.push('test-field-equipment-work-time.js','test-field-maintenance-labor.js');
scripts.push('test-field-maintenance-materials.js');
...
scripts.push('test-field-reminder-materials.js');
scripts.push('test-field-reminder-partial-returns.js');
scripts.push('test-field-reminder-visits.js');
...
scripts.push('test-field-equipment-history-materials.js');
scripts.push('test-field-equipment-history-time.js');
