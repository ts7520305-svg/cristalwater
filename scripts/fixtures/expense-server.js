...
for (const page of ['admin-expenses', 'admin-ai', 'labor-cost-bases', 'equipment-material-review', 'reminder-resources', 'reminder-materials']) app.get('/' + page, (req, res) => res.sendFile(path.resolve(__dirname, '../../frontend/' + page + '.html')));
