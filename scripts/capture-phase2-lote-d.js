...
const OUT_DIR = path.join(__dirname, "..", "docs", "product", "screenshots", "phase2-lote-d");

const TARGETS = [
  { page: "admin-reports", route: "/admin-reports" },
  { page: "report-settings", route: "/report-settings" },
  { page: "metrics", route: "/metrics" },
  { page: "ranking", route: "/ranking" },
  { page: "communications", route: "/communications" },
  { page: "chat", route: "/chat" },
  { page: "notifications", route: "/notifications" },
  { page: "admin-notifications", route: "/admin-notifications" },
  { page: "admin-email-logs", route: "/admin-email-logs" },
  { page: "admin-service-log", route: "/admin-service-log" },
  { page: "config-notifications", route: "/config-notifications" },
  { page: "help-center", route: "/help-center" },
];
...
(async () => {
  ...
  console.log("Captura Lote D concluida:", report.totals);
})().catch((error) => {
  console.error(error);
  process.exit(1);
});
