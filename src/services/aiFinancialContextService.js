...
async function snapshot(monthRef) {
  ...
  try {
    return await prisma.$transaction(async db => {
      ...
      return { ...base, expenses, costCoverage, revenueCoverage, state:revenueCoverage.monthlyAllocations.reviewCount > 0 || revenueCoverage.documents.review > 0 || revenueCoverage.lines.review > 0 || review || expenses.state === 'REVIEW' || expenses.attribution.state === 'REVIEW' ? 'REVIEW' : 'READY',
