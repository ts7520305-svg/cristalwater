(function () {
  ...
  window.CWFieldWriteStore = { session, adminSession:()=>session(true), same, prepare, send, records, get, remove, flush, digest, hash, confirmation, acknowledgeRejection, equipmentMaterials };
})();
