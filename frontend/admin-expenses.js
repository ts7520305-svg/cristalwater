(function () {
  ...
  Object.assign(commandNames, {SET_LABOR_DISTRIBUTION:'Repartição do trabalho por técnico/período',VOID_LABOR_DISTRIBUTION:'Anulação da repartição do trabalho'});
