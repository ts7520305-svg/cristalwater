(function () {
  ...
  Object.assign(commandNames, {SHARE_MAINTENANCE_LABOR:'Repartição do trabalho com manutenção',VOID_MAINTENANCE_LABOR_SHARE:'Anulação da parcela da manutenção',SET_LABOR_DISTRIBUTION:'Repartição do trabalho por técnico/período',VOID_LABOR_DISTRIBUTION:'Anulação da repartição do trabalho'});
