(() => {
 ...
 const labels={MISSING:'Não existe cópia local identificada.',EMPTY:'A cópia mais recente está vazia.',STALE:'A cópia local está desatualizada.',JSON_FALLBACK:'Existe uma exportação JSON de recurso. Falta verificar um restauro compatível.',FUTURE_TIMESTAMP:'A data do ficheiro está no futuro. Verifique o relógio.',UNREADABLE:'Não foi possível ler a pasta de backups.',CONFIG_ERROR:'Configuração da verificação inválida.',RECENT_LOCAL_SQL:'Existe uma cópia SQL local recente. Restauro e cópia externa por verificar.'};
