...
const CACHE = 'cristalwater-field-20260926-v193';
...
self.addEventListener('install', event => {
  ...
  APP_SHELL.push('/cw-field-route-cache.js', '/cw-field-guide-projection.js', '/cw-field-documents.js', '/cw-field-document-copy.js', '/cw-field-materials.js', '/cw-visit-product-identity.js', '/cw-extra-visit-correction.js', '/field-equipment-maintenance.js');
