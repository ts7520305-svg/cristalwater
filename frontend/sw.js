...
const CACHE = 'cristalwater-field-20260916-v30';
...
self.addEventListener('install', event => {
  APP_SHELL.push('/cw-field-write-store.js', '/js/offline/offline-queue.js', '/js/offline/offline-photos.js', '/technician', '/technician.html', '/technician.js', '/logo-cristalwater.png');
