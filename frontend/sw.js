...
const CACHE = 'cristalwater-field-20260917-v44';
...
self.addEventListener('install', event => {
  ...
  APP_SHELL.push('/cw-field-route-cache.js', '/cw-extra-visit-correction.js', '/field-equipment-maintenance.js');
  APP_SHELL.push('/cw-legacy-workday.js','/cw-incomplete-workflow.js','/cw-field-incomplete.js');
