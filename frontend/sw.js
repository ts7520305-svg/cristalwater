...
const CACHE = 'cristalwater-field-20260916-v32';
const APP_SHELL = ['/technician-field-mode','/technician-login','/cw-auth.js','/technician-auth-guard.js','/cw-field-offline.js','/cw-pump-reminders.js','/cw-field-recovery.js','/cw-field-photos.js','/cw-browser-push.js','/cw-push-session.js','/cw-proposal-requests.js','/cw-proposal-editor.js','/js/offline/offline-gps.js','/technician-gps','/technician-gps.js','/technician-field-mode.js','/cw-ui-feedback.js','/cw-auth-download.js','/crystal-os-v2-shell.js','/crystal-os-v2-nav.js','/cw-ui-kit.css','/cw-field-professional.css','/ui/foundation.css','/ui/core/navigation-context.js','/ui/design-system.js','/ui/state-adapter-v2.js'];
self.addEventListener('install', event => {
  APP_SHELL.push('/cw-field-write-store.js', '/cw-field-internal-alert.js', '/cw-field-route-preview.js', '/js/offline/offline-queue.js', '/js/offline/offline-photos.js', '/technician', '/technician.html', '/technician.js', '/logo-cristalwater.png');
