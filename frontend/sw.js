...
const CACHE = 'cristalwater-field-20260916-v31';
...
self.addEventListener('install', event => {
  APP_SHELL.push('/cw-field-write-store.js', '/cw-field-internal-alert.js', '/js/offline/offline-queue.js', '/js/offline/offline-photos.js', '/technician', '/technician.html', '/technician.js', '/logo-cristalwater.png');
