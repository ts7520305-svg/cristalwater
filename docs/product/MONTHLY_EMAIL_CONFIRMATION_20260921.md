...
Publicação e execução integral no CI PostgreSQL 16/restauro pendentes neste checkpoint. Todos os contactos foram simulados, com integrações externas desativadas no ambiente QA.
