...
Regressões dirigidas aprovadas: materiais próprios TASK309, repartição MATERIAL TASK310 e repartição LABOR TASK308, incluindo os respetivos percursos reais no navegador. Ensaios locais usam PostgreSQL embebido em ambiente isolado; o CI completo com PostgreSQL 16 e restauro desta árvore continua por confirmar. O runner passa a 214 grupos; mantém 35 migrações e 126 tabelas, sem dependências novas. Não há aprovação de volume ou de operação prolongada nesta entrega.
