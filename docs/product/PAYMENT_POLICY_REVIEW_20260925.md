...
TASK355 confirmada em [252/252 grupos e restauro nativo](evidence/20260925_task355_ci.json), 17 etapas e 127 tabelas/47 ficheiros com linhas e hashes iguais. TASK356 continua em execução no último controlo. Lote validado localmente; publicação e CI desta alteração por confirmar. Sem merge, deploy de produção ou contactos reais. Aplicação não declarada completa.
