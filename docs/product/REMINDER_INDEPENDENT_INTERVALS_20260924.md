...
- Migração local: esquema anterior recuperado, 39 migrações aplicadas, linhas e comprovativos legados preservados, rejeição das combinações inválidas e equivalência com o esquema atual. O CI nativo repetiu e aprovou o percurso desde o commit histórico.
