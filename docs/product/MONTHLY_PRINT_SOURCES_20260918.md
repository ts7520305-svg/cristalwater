...
Prioridade revista após pedido do utilizador: tratar o plano sazonal por cliente que liga serviços, frequência de visitas, agenda e valores; ver `SEASONAL_CLIENT_SERVICE_REQUIREMENT_20260918.md`. Depois retomar a abertura autenticada a partir dos alertas e a incorporação de fotografias com autorização confirmada. Relatórios EXTRA, fontes Unicode e restantes validações documentadas mantêm o seu âmbito próprio. Sem merge em main, deploy/VPS, fornecedores, envios reais ou emissão fiscal.
