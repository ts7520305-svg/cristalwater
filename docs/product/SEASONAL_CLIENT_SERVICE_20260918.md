...
Interface completa aprovada com Chromium 149 em `run-1789722098016`, incluindo larguras 320/390/1440, contraste claro/escuro, seis visitas, rascunhos, resposta perdida, confirmação trocada, repetição, offline, falha de armazenamento e mudança de sessão. A captura de 320 px foi revista. A versão local anterior de Chromium era 153, pelo que a passagem nela não provava a apresentação do navegador do CI. Confirmar agora o novo commit no workflow completo e no restauro.

## Limites e continuação

Publicação atual: **concluída na branch de trabalho**, após autorização explícita do proprietário em 18/09 («Sim continua»). Commit publicado `5addca4fcabc503f73982ab273612ca57b248c6e`, árvore `114a6d0097e89aaed483d21e95e0b3ad0f3c8c09`, igual à árvore local revista `f7924e4` e com a implementação original `664f311`. A referência avançou sem força e conserva o rascunho anterior no histórico. [CI `35325817914`](https://github.com/ts7520305-svg/cristalwater/actions/runs/35325817914), job `105538493888`, terminou com 147/148 grupos e a falha de apresentação descrita acima. A correção local requer publicação e novo CI/restauro.
