...
- Gates locais: 396 unitários/63 ficheiros, quatro técnicos e sintaxe 563 backend/185 frontend/56 inline aprovados. O CI PostgreSQL 16, navegador e restauro do novo lote têm de ser confirmados após publicação; a aprovação de TASK277 não é apresentada como aprovação deste código.
