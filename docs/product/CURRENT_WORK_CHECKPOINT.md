...
- Última entrega remota verificada antes da TASK147: TASK146, commit `0ea9d368a0a5779693b5ee2b79567f600bd5f658`; workflow `34999757586` aprovado, incluindo 323 testes unitários, 17 scripts de navegador, 51 grupos operacionais, PostgreSQL 16 e restauro de 99 tabelas/11 anexos.
...
1. TASK144/TASK145 conservam crédito automático/mensal; TASK146 regista a totalidade dos recebimentos Finance OS no histórico; TASK147 protege e audita ajustes internos, distinguindo-os dos recebimentos, e repara o ecrã de cobranças. Confirmar workflow final com 52 grupos; não repetir estas correções. Prosseguir pela harmonização dos preços da faturação mensal antiga com os planos por cliente e pela revisão dos outros caminhos que alteram crédito/faturas (ativação de contrato, regeneração e notas de crédito), sem migrações ou reescritas históricas automáticas.
