...
- Última entrega remota verificada antes da TASK149: TASK148, commit `eed0fbceb42d90a6b6fb27432ab2bdd0c492a900`; workflow `35003739054` aprovado, incluindo 323 testes unitários, 17 scripts de navegador, 53 grupos operacionais, PostgreSQL 16 e restauro de 99 tabelas/11 anexos.
...
1. TASK144–TASK149 conservam crédito, registam excedentes, auditam ajustes internos, integram planos e protegem a geração core/operacional contra substituição de faturas. Confirmar workflow final com 54 grupos; não repetir estas correções. Prosseguir pelos geradores de `invoiceRoutes` (criação e crédito ainda em transações separadas), referências de reparações já cobradas noutros meses, ativação de contrato e notas de crédito. Não fazer migrações ou reescritas históricas automáticas. Os valores de recurso dos clientes sem plano e as diferenças de categorias entre percursos foram conservados.
