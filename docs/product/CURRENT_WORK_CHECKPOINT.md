...
- TASK137 implementada: rascunhos identificados, filtro próprio, ações de pagamento/PDF protegidas, valores cobraveis coerentes no ecrã/API/dashboard, estado de adiantamento e recuperação de consultas/sessão. Reprodução em `field-qa-runtime/run-1789483176194`; ensaio dirigido final aprovado em `field-qa-runtime/run-1789483564490`, incluindo pagamentos e faturação de alertas. Relatório `DRAFT_VISIBILITY_20260915.md`. 322 testes unitários, quatro de técnicos e sintaxe de 496 ficheiros backend aprovados. Confirmar workflow final com 43 grupos e restauro.
