...
- Última entrega remota verificada antes da TASK148: TASK147, commit `b6082068c39980cc33cbc24ce4b9b4edfd551401`; workflow `35002003348` aprovado, incluindo 323 testes unitários, 17 scripts de navegador, 52 grupos operacionais, PostgreSQL 16 e restauro de 99 tabelas/11 anexos.
...
1. TASK144/TASK145 conservam crédito automático/mensal; TASK146 regista a totalidade dos recebimentos Finance OS; TASK147 protege ajustes internos e repara o ecrã de cobranças; TASK148 integra os planos explícitos de cliente no gerador mensal antigo. Confirmar workflow final com 53 grupos; não repetir estas correções. Prosseguir pela revisão dos outros caminhos que alteram crédito/faturas (ativação de contrato, regeneração e notas de crédito), sobretudo os geradores core/operacional sem plano que ainda fazem upsert e substituição de linhas. Não fazer migrações ou reescritas históricas automáticas. Valores de recurso para clientes sem plano foram conservados, não escolhidos de novo silenciosamente.
