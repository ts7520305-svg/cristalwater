...
Implementação sobre o checkpoint `086632dba7502413c087a6a8221b74c7cb0a2d6c`. TASK247 corrige a API de configurações; TASK248 liga a interface ao cliente, conta e versão confirmados, com rascunhos e recuperação. A versão final com correção da concorrência do painel está publicada em `4d997baa22ad7cdb063943028df8eebb0548d0f4`, árvore `6576604408948e059fe87a9f4165230e5f71bee4`; [CI `35304938643`](https://github.com/ts7520305-svg/cristalwater/actions/runs/35304938643): configurações aprovadas, mas 141/142 grupos por uma falha de sessão no acompanhamento de regressos, tratada na TASK249. Confirmar a árvore conjunta. Evidência local e histórico das duas execuções anteriores abaixo.
