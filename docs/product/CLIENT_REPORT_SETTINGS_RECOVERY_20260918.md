...
Implementação sobre o checkpoint `086632dba7502413c087a6a8221b74c7cb0a2d6c`. TASK247 corrige a API de configurações; TASK248 liga a interface ao cliente, conta e versão confirmados, com rascunhos e recuperação. Validação local aprovada. Código publicado em `87be4ade81e4443f473c065fe5ed43dfc148af41`; reforço da medição visual no teste em `4bf06ecbeede6abae2f12766428029d024595df1`, árvore `af775757c7fac87cc2fc04cfc46e586ed553d41a`. Esse CI aprovou o conjunto, mas a corrida intermitente do painel identificada no primeiro CI exigiu a correção adicional abaixo; confirmar a nova árvore antes de fechar o lote.
