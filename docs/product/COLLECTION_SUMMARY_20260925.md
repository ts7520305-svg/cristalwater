...
Preparada e validada localmente; publicação e CI/restauro nativos deste lote ainda por registar. TASK351 confirmada em [250/250 grupos e restauro nativo](evidence/20260925_task351_ci.json). TASK352 publicada em `b0a000d9df20d47dc1079e2db4fe17966525b492`; CI `36119724596` em execução no último controlo.
