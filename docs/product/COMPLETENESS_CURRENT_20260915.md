...
Atualizada após implementação da TASK189 em 16/09/2026. Substitui a fotografia inicial da TASK82 para decidir o próximo trabalho, preservando esse diagnóstico em `COMPLETENESS_20260915.md`. Esta matriz cruza os relatórios posteriores e as rotas atualmente revistas; não constitui auditoria exaustiva de todas as páginas/APIs nem conclusão a 100%.
...
| Edição de clientes | Campos omitidos preservados e auditoria atómica nos dois aliases; credenciais excluídas das respostas e da auditoria | TASK188; `CLIENT_EDIT_PRESERVATION_20260916.md`. CI `35076385728` aprovado com 90 grupos e restauro. Versão, conflitos e recuperação do formulário continuam pendentes. |
| Edição geral de piscinas | Escritor partilhado com alteração, ficha técnica, transferência de visitas elegíveis e histórico na mesma transação; campos técnicos omitidos preservados | TASK189; `POOL_EDIT_ATOMICITY_20260916.md`. Três grupos locais aprovados; confirmar CI da árvore publicada com 91 grupos. Rota específica da ficha técnica, propostas, versão e recuperação continuam pendentes. |
...
1. Confirmar o CI da TASK189, que corrige os dois aliases de edição geral de piscinas. Retomar versão, conflitos, confirmação e recuperação dos formulários de clientes/piscinas. Rever separadamente a rota específica da ficha técnica e as propostas; a atomicidade da edição geral não comprova estes percursos. TASK188 e pedidos de visita/avisos de pagamento já estão confirmados no CI.
