...
Atualizada após implementação da TASK190–191 em 16/09/2026. Substitui a fotografia inicial da TASK82 para decidir o próximo trabalho, preservando esse diagnóstico em `COMPLETENESS_20260915.md`. Esta matriz cruza os relatórios posteriores e as rotas atualmente revistas; não constitui auditoria exaustiva de todas as páginas/APIs nem conclusão a 100%.
...
| Edição de clientes | Preservação/auditoria atómicas, versão opaca, UUID e comprovativo imutável; editor com pedido recuperável, revisão por campo e isolamento entre contas/clientes; credenciais fora dos registos do navegador | TASK188 e 190–191; `CLIENT_EDIT_PRESERVATION_20260916.md` e `CLIENT_EDIT_RECOVERY_20260916.md`. Dois processos, duas janelas, falhas, cinco idiomas e mobile/desktop ensaiados. Confirmar CI da árvore nova com 93 grupos/catorze migrações. Chamadas antigas sem UUID não recebem proteção própria de versão/reenvio. |
| Edição geral de piscinas | Escritor partilhado com alteração, ficha técnica, transferência de visitas elegíveis e histórico na mesma transação; campos técnicos omitidos preservados | TASK189; `POOL_EDIT_ATOMICITY_20260916.md`. CI `35078224632` aprovado com 91 grupos e restauro de 104 tabelas/22 ficheiros. Rota específica da ficha técnica, propostas, versão e recuperação continuam pendentes. |
...
1. Confirmar o CI da TASK190–191 e retomar versão, conflitos, confirmação e recuperação do editor de piscinas. Rever separadamente a rota específica da ficha técnica e as propostas; a atomicidade da edição geral não comprova estes percursos. A recuperação do editor de clientes está implementada, com limites descritos no respetivo relatório.
