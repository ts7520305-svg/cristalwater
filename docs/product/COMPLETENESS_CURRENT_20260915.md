...
Atualizada após implementação da TASK192–193 em 16/09/2026. Substitui a fotografia inicial da TASK82 para decidir o próximo trabalho, preservando esse diagnóstico em `COMPLETENESS_20260915.md`. Esta matriz cruza os relatórios posteriores e as rotas atualmente revistas; não constitui auditoria exaustiva de todas as páginas/APIs nem conclusão a 100%.
...
| Edição geral de piscinas | Alteração, campos técnicos explícitos, transferência seletiva de visitas, histórico e comprovativo na mesma transação; versões da piscina/relações e destinatário; formulário recuperável com revisão por campo | TASK189 e 192–193; `POOL_EDIT_ATOMICITY_20260916.md` e `POOL_EDIT_RECOVERY_20260916.md`. Dois processos/janelas, falhas, cinco idiomas e mobile/desktop ensaiados. Confirmar CI da árvore nova com 95 grupos/quinze migrações. Rota específica da ficha técnica e propostas continuam pendentes; chamadas sem UUID não têm proteção própria de versão/reenvio. |
...
1. Confirmar o CI da TASK192–193 e rever a atomicidade/recuperação da rota específica da ficha técnica e das propostas. A edição geral não comprova esses percursos. A recuperação dos editores gerais de clientes/piscinas está implementada, com limites nos respetivos relatórios.
