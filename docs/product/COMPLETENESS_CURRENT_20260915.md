...
| Edição de clientes | Correção preparada para preservar campos omitidos e guardar a auditoria atomicamente nos dois aliases; credenciais excluídas das respostas e da auditoria | TASK188; `CLIENT_EDIT_PRESERVATION_20260916.md`. Perda de dados reproduzida em QA; nova implementação depende do CI da árvore publicada, pois o executor desligou-se. Versão, conflitos e recuperação do formulário continuam pendentes. |
