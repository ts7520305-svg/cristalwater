...
Atualização posterior: a [TASK368](TRANSPORT_GUIDE_ITEMS_20260925.md) substituiu o escritor destrutivo de materiais por edição revista/transacional com IDs explícitos e conservação dos consumos. A retoma atual passa aos metadados/estado e anexos, conforme o checkpoint.
