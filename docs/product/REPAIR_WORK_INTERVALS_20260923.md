...
A validação local usa o adaptador PostgreSQL PGlite e Chromium 149. O runner passa a 195 grupos. Confirmar o CI nativo PostgreSQL 16 da versão publicada, incluindo concorrência e restauro, antes do fecho.
