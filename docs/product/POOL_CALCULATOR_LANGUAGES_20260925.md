...
Código validado localmente; publicação e CI deste lote por confirmar. O CI da TASK346 passou em 245/245 grupos esperados distintos e 17 etapas, incluindo restauro PostgreSQL de 127 tabelas e 47 ficheiros com linhas e hashes iguais ([evidência](evidence/20260925_task346_ci.json)). A TASK347 permanece em execução no último controlo; não se antecipa a aprovação do respetivo restauro.
