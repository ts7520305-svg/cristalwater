...
- Runner com 223 grupos; cache `cristalwater-field-20260924-v135`. Sem nova migração, tabela ou dependência; o total permanece 39 migrações. CI nativo e restauro deste lote ainda pendentes nesta versão documental.
