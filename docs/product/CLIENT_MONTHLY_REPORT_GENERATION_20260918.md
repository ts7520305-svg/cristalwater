...
`run-1789764573709`: relatório EXTRA e acesso mensal aprovados antes do novo grupo; este ultrapassou a antiga colisão, verificou os totais/volume, rollback, processos concorrentes e os dois PDFs. Continua a terminar com P2028 apenas no ensaio final de duas transações simultâneas, pela limitação PGlite já documentada. 396 unitários/63 ficheiros e quatro testes técnicos novamente aprovados. Foi necessária nova validação integral nativa e restauro, confirmada abaixo; o primeiro CI não aprovou a entrega.

CI PostgreSQL 16 e restauro aprovados: commit `686a5f250c0f85ac0712de70b14dc0ac146e54ce`, árvore `1b72819ad7b80d0013d9e6b5c097b0a180361201`, [run 35393726477](https://github.com/ts7520305-svg/cristalwater/actions/runs/35393726477), job `105757679396`, concluído em 18/09/2026 às 21:09:11 UTC. Confirmados 154/154 grupos distintos, todos com código zero e sem sinal; novo grupo mensal em 962 ms, incluindo leitura consistente durante alteração noutra ligação, três processos concorrentes e rollback, sem remover qualquer asserção. Sintaxe 560/183/56, 396 unitários/63 ficheiros, quatro técnicos, gate do navegador e 21 migrações aditivas aprovados. Restauro de 110 tabelas e 46 ficheiros carregados, com linhas e hashes iguais. Esta execução fecha a limitação de validação nativa e a falha de preparação do primeiro CI.

A atualização final altera apenas este relatório e o checkpoint, conservando o código/testes da árvore aprovada. Publicação na branch autorizada `work/field-readiness-20260915-simulation`, sem merge ou instalação no VPS. Backups locais `backup/client-monthly-generation-local-20260918` e `backup/client-monthly-generation-sequence-local-20260918`.
