...
A regressão completa das propostas aprovou em `run-1789662299419`, incluindo interface ADMIN/técnico, transações, conflitos e privacidade. Confirmar o CI/restauro da árvore final antes de considerar o lote aprovado globalmente. O CI anterior terminou com falha e omitiu o restauro.
