...
- Criações modernas identificadas pela conta autenticada e identificador local. O servidor conserva o hash do pedido; repetir o identificador com outra visita/tipo/prazo/nota é recusado.
...
- Revisão do fim do dia inclui pendências dos dois tipos de visita. Cache pública atualizada para v40, incluindo o novo módulo; dados operacionais permanecem privados.
