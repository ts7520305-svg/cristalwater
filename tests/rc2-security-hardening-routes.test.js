...
describe("RC2 security hardening route guards", () => {
  ...
  it("opens protected guide PDFs through an authenticated download", () => {
    ...
    const admin = read("frontend/cw-fleet-history.js");
    expect(read("frontend/admin-vehicles.html")).toContain('src="/cw-fleet-history.js"');
    ...
    expect(admin).toMatch(/dataset\.authDownload/);
